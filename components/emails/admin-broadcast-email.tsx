      ...
      <Body style={{ fontFamily: "Newsreader, serif", textAlign: "center" }}>
        <Container style={{ padding: "24px 0 36px 0", margin: "0 auto" }}>
          {imageUrl ? (
            ...
            <Section style={{ textAlign: "center", margin: "32px 0" }}>
              <Img
                src="https://getstuff.city/stuffmkrt.png"
                alt="Stuff Logo"
                width="400"
                style={{ margin: "0 auto" }}
              />
            ...
            switch (comp.type) {
              ...
              case "image":
                return (
                  ...
                  >
                    <Img
                      src="https://getstuff.city/founders.gif"
                      alt="Stuff Logo"
                      width="400"
                      style={{ margin: "0 auto" }}
                    />
              ...
              case "link":
                return (
                  <Link href={comp.link} style={{ fontSize: "18px" }}>
                    {comp.link}
                  </Link>
                );
              default:
          ...
          <Link href="https://getstuff.city" style={{ fontSize: "18px" }}>
            getstuff.city
          </Link>
        </Container>
      </Body>
